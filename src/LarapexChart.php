...
class LarapexChart
{
    ...
    */
    ...
    {
        return json_decode($this->horizontal, true)['horizontal'];
    }

    public function xAxis(): array
    {
        return json_decode($this->xAxis, true);
    }

    public function grid(): bool
    {
        return json_decode($this->grid, true)['show'];
    }

    public function markers(): bool
    {
        return json_decode($this->markers, true)['show'];
    }

    public function stroke(): array|null
    {
        return json_decode($this->stroke, true);
    }

    public function toolbar(): bool
    {
        return json_decode($this->toolbar, true)['show'];
    }

    public function zoom(): bool
    {
        return json_decode($this->zoom, true)['enabled'];
    }

    public function dataLabels(): bool
    {
        return json_decode($this->dataLabels, true)['enabled'];
    }

    public function sparkline(): bool
    {
        return json_decode($this->sparkline, true)['enabled'];
    }
